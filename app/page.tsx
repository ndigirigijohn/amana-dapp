...
import { ArrowRight, Shield, Coins, TrendingUp, Check, ExternalLink } from 'lucide-react';
        ...
        <section className="relative min-h-screen flex items-center justify-center px-6 pt-20">
          ...
          <div className="relative z-10 text-center max-w-6xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-20">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 px-10 py-4 text-lg font-semibold transition-all duration-300 transform hover:scale-105"
                asChild
              >
                <a href="/entity-registry" className="flex items-center space-x-3">
              ...
              <Button 
                variant="outline" 
                size="lg" 
                className="border-white/20 hover:bg-white/5 hover:border-emerald-500/50 px-10 py-4 text-lg font-semibold transition-all duration-300"
              >
                <span>View Demo</span>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div key={index} className="group relative">
                  ...
                  <div className="relative bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-emerald-500/30 transition-all duration-500">
              ...
              {processSteps.map((step, index) => (
                <div key={index} className="relative">
                  {index < processSteps.length - 1 && (
                    <div className="hidden md:block absolute top-16 left-full w-full h-0.5 bg-gradient-to-r from-emerald-500/50 to-transparent z-0"></div>
                  )}
                  <div className="relative z-10 text-center">
                    <div className="w-32 h-32 mx-auto mb-8 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full flex items-center justify-center text-3xl font-bold text-white">
                      {step.step}
                    </div>
                    <h3 className="text-2xl font-bold mb-4 text-white">
                      {step.title}
